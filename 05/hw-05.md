...
```
Значения var.cloud_id, var.folder_id и var.token вспоминаем командой `yc config list`
```
terraform apply -lock=false
```
![Alt_text](https://github.com/LeonidKhoroshev/ter-homeworks/blob/main/05/screenshots/ter5.png)
Проверяем наш s3 bucket
![Alt_text](https://github.com/LeonidKhoroshev/ter-homeworks/blob/main/05/screenshots/ter6.png)
