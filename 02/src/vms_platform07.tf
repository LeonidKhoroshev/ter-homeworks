...
variable "vm_metadata" {
  type      = map
  default   = {serial_port_enable = "1", ssh_keys = "ubuntu:AAAAB3NzaC1yc2EAAAADAQABAAABAQCgT8Ny1LD7hTjTan3NOKzgpZ9FEJC7+G7Zfm+bs+9bXZhQ/B6gwjJh0VI6RsVo2wZKsosIc2DZogA+NlWbefQfiC5RKtt/iZME$
}
