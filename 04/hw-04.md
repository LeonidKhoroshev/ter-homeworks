...
main.tf
```
vpc_subnet_id = "e9bhs1lhmctlq5d3nun7"
...
```
docker run --rm --volume "$(pwd):/terraform-docs" -u $(id -u) quay.io/terraform-docs/terraform-docs:0.17.0 markdown /terraform-docs > doc.m
```
